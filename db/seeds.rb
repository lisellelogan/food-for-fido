...
admin = User.create({name: "Fido Admin", email: "admin@fido.com", password: "admin", admin: true})
beemo = User.create({name: "Beemo", email: "beemo@beemo.com", password: "beemo"})
seymour = User.create({name: "Seymour", email: "seymour@seymour.com", password: "seymour"})
oscar = User.create({name: "Oscar", email: "oscar@oscar.com", password: "oscar"})
charlie = User.create({name: "Charlie", email: "charlie@charlie.com", password: "charlie"})
...
#comment data
beemo_comment = beemo.comments.create(rating: 3, content: "Good but kind of bland.", recipe_id: chimken_rice.id)
seymour_comment = seymour.comments.create(rating: 4, content: "I love a pawsta dish!", recipe_id: spawghetti.id)
oscar_comment = oscar.comments.create(rating: 5, content: "So good! I had this for my dog's birthday and he loved it!", recipe_id: boodday_cake.id)
charlie_comment = charlie.comments.create(rating: 1, content: "Veggies were not my dog's thing.", recipe_id: veggie_pawty_bowl.id)